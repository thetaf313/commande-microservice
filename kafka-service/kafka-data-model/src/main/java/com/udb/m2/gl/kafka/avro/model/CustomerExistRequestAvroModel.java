...
public class CustomerExistRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1075310954946982210L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerExistRequestAvroModel\",\"namespace\":\"com.udb.m2.gl.kafka.avro.model\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder newBuilder() {
    return new com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder();
  }
   ...
   * @return A new CustomerExistRequestAvroModel RecordBuilder
   */
  public static com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder newBuilder(com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder();
    } else {
      return new com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerExistRequestAvroModel RecordBuilder
   */
  public static com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder newBuilder(com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel other) {
    if (other == null) {
      return new com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder();
    } else {
      return new com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerExistRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.udb.m2.gl.kafka.avro.model.CustomerExistRequestAvroModel.Builder clearClientId() {
      clientId = null;
